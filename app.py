...
🚨 [품목별 적용 법률 엄격 분리] 🚨
1. 질문의 품목이 '우유, 가공유, 발효유' 등 유제품인 경우: 주로 「축산물 위생관리법」 및 유가공업 관점 적용
2. 질문의 품목이 '두유, 과채음료' 등 일반 식품인 경우: 절대 축산물법을 언급하지 말고, 오직 「식품위생법」 또는 「식품표시광고법」 관점만 적용
