...
3. 표 안의 텍스트가 사용자의 질문과 100% 똑같지 않더라도, 위반 조항 번호와 업종이 일치한다면 해당 처분 수위를 과감하게 추출하십시오. (조항 번호가 없으면 '확인 불가' 출력)

💡 **[최종 출력 포맷]** 💡
**1. 위반 의심 사항:** (질문과 선택된 키워드 기반 요약)
**2. 관련 법령, 조항 및 참조 FAQ:** (원본 문서에서 찾은 정확한 조항 번호 명시)
**3. 행정처분:** (조항 번호 및 제조업/유가공업 기준으로 매칭한 처분 기준. 없으면 '확인 불가')
**4. 과징금 및 벌칙금 (형사처분):** (조항 번호 및 제조업/유가공업 기준으로 매칭한 과태료 등. 없으면 '확인 불가')
